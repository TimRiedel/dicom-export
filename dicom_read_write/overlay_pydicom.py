...
def write_dicom_overlay(filePath, save_as="out.dcm", overlay_shape=3):
  overlay_shapes = {
    1: generate_chess_overlay_mask,
    2: generate_chess2_overlay_mask,
    3: generate_random_mask,
  }
  ...
  mask = overlay_shapes[overlay_shape](image_data.shape[0], image_data.shape[1])
  add_overlay(ds, mask)
